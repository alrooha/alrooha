      ...
      <div className="w-full md:w-1/2 space-y-8">
        <motion.div variants={fadeIn("right", 0.2)} initial="hidden" whileInView="show">
          ...
          <div className="flex items-center gap-2 bg-gray-50 w-fit px-4 py-2 rounded-full hover:bg-gray-100 transition-colors cursor-pointer group">
            ...
            <span className="text-sm font-medium">Global Trading Excellence</span>
          </div>
        </motion.div>
        ...
        >
          Al-Rooha connects global markets with reliable multi-commodity trading solutions. From sourcing to logistics
          coordination, we deliver excellence in international trade.
        </motion.p>
