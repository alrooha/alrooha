      ...
      >
        <div className="relative md:px-16 px-6 py-16 md:py-24">
          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12">
            {/* Left Content */}
            <motion.div variants={fadeIn("right", 0.5)} className="text-white max-w-lg text-center md:text-left">
              <motion.h2 variants={textVariant(0.3)} className="text-2xl sm:text-3xl md:text-4xl font-medium mb-4">
                Stay Updated on Global Markets
              </motion.h2>
              <motion.p variants={fadeIn("up", 0.6)} className="text-blue-100 text-sm sm:text-base">
                Get exclusive market insights, commodity trends, and trading opportunities delivered to your inbox
                weekly
              </motion.p>
            </motion.div>

            {/* Email Form */}
            <motion.div variants={fadeIn("left", 0.5)} className="w-full md:w-auto">
