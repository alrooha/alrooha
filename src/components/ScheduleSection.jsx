    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24">
        ...
        <motion.div variants={fadeIn("left", 0.3)} className="w-full md:w-1/2">
          <motion.span variants={fadeIn("up", 0.4)} className="text-orange-500 font-semibold">
            EFFICIENCY
          </motion.span>
          <motion.h2 variants={textVariant(0.5)} className="text-3xl md:text-4xl font-bold text-navy-900 mt-4 mb-6">
            ...
            With Al-Rooha's Smart Solutions
          </motion.h2>
          <motion.p variants={fadeIn("up", 0.6)} className="text-gray-600 mb-8">
            Optimize your commodity trading with our intelligent coordination system. Track shipments in real-time,
            manage documentation effortlessly, and connect with verified logistics partners for transparent and timely
            delivery worldwide.
          </motion.p>
          <motion.a
