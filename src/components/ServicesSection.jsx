  ...
  const services = [
    {
      ...
      description: "Direct access to verified suppliers across agricultural, metals, and energy sectors globally.",
      link: "#learn-more",
    },
    {
      ...
      description:
        "Complete handling of customs paperwork, certificates, and regulatory compliance for smooth cross-border trade.",
      link: "#learn-more",
    },
    {
      ...
      description:
        "Partnerships with trusted carriers ensuring reliable and cost-effective commodity transportation worldwide.",
      link: "#learn-more",
    },
    {
      icon: <BiTime className="w-8 h-8 text-cyan-400" />,
      title: "Market Intelligence",
      description: "Real-time pricing updates and market trends to help you make informed trading decisions.",
      link: "#learn-more",
    },
  ]
      ...
      >
        ...
        <motion.div variants={fadeIn("right", 0.4)} className="md:w-1/3">
          ...
          <motion.p variants={fadeIn("up", 0.5)} className="text-gray-600 text-lg mb-4 md:w-4/5">
            Al-Rooha provides end-to-end solutions for international commodity trading
          </motion.p>
          <motion.div variants={fadeIn("up", 0.6)} className="space-y-3">
            <motion.div variants={fadeIn("right", 0.7)} className="flex items-center gap-2">
              ...
              <span className="text-gray-600">Multi-commodity expertise</span>
            </motion.div>
            <motion.div variants={fadeIn("right", 0.8)} className="flex items-center gap-2">
              <div className="w-5 h-5 rounded-full bg-indigo-100 flex items-center justify-center">
                <div className="w-2.5 h-2.5 rounded-full bg-indigo-600"></div>
              </div>
              <span className="text-gray-600">Global logistics network</span>
            </motion.div>
          </motion.div>
          <motion.button
