...
const PricingSection = () => {
  ...
  return (
    <motion.section variants={fadeIn("up", 0.2)} initial="hidden" whileInView="show" className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <motion.h2 variants={textVariant(0.3)} className="text-3xl md:text-4xl font-bold text-center mb-16">
          Flexible Trading Plans
        </motion.h2>

        <motion.div variants={fadeIn("up", 0.4)} className="grid md:grid-cols-2 gap-8 mb-12">
          {/* Starter Plan */}
          <motion.div variants={fadeIn("right", 0.5)} className="bg-white p-8 rounded-lg shadow-lg">
            <motion.h3 variants={fadeIn("up", 0.6)} className="text-xl text-gray-600 mb-4">
              Startup Trader
            </motion.h3>
            <motion.p variants={fadeIn("up", 0.7)} className="text-3xl font-bold mb-6">
              ${starterPrice}/mo
            </motion.p>
          </motion.div>

          {/* Business Plan */}
          <motion.div variants={fadeIn("left", 0.5)} className="bg-white p-8 rounded-lg shadow-lg">
            <motion.h3 variants={fadeIn("up", 0.6)} className="text-xl text-gray-600 mb-4">
              Enterprise Trader
            </motion.h3>
            <motion.p variants={fadeIn("up", 0.7)} className="text-3xl font-bold mb-6">
        ...
        <motion.div variants={fadeIn("up", 0.8)} className="max-w-xl mx-auto">
          <motion.p variants={fadeIn("up", 0.9)} className="text-center text-gray-600 mb-4">
            {productCount} commodity shipments
          </motion.p>
